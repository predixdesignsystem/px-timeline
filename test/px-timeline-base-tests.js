...
document.addEventListener("WebComponentsReady", function() {
  console.log('in the web components ready');
  runBaseTests();
  runCustomTests();
});
...
function runBaseTests() {
  ev_timeline_1 = document.getElementById('ev_timeline_1');

  suite('Base Automation Tests for px-timeline', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-timeline fixture is created', function() {
      assert.isTrue(document.getElementById('ev_timeline_1') !== null);
    });
